...
const TeleMedicineNavbar = () => {
    ...
    const menuItems = [
        { name: "Hospitals", icon: <FaHospitalAlt />, link: "/userlogin" },
        { name: "Pharmacy", icon: <FaCapsules />, link: "/userlogin" },
        { name: "Laboratory", icon: <FaMicroscope />, link: "/userlogin" },
        { name: "Telemedicine", icon: <FaSyringe />, link: "/SignupModalTelemedicine" },
        { name: "Pro Life", icon: <FaHeartbeat />, link: "/userlogin" },
      ];
...
export default TeleMedicineNavbar
