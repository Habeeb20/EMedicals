...
const MortuarySignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${import.meta.env.VITE_API_m}/msignup`, formData, {
        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#FFF9E8] mt-6">
            <div className="w-full max-w-md bg-white p-8 rounded shadow-md">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded shadow-md max-w-lg w-full space-y-4">
                    ...
                    {/* name */}
                    <input type="text" name="name" placeholder="name" value={formData.name} onChange={handleChange} className="w-full p-2 border rounded" disabled={isLoading} />
