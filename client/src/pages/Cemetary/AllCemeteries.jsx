...
//     if (flowerSearch) {
//       results = results.filter(cemetery => cemetery.flowers.some(flower => flower.name.includes(flowerSearch)));
//     }

//     if (verseSearch) {
//       results = results.filter(cemetery => cemetery.verses.some(verse => verse.name.includes(verseSearch)));
//     }

//     if (casketSearch) {
//       results = results.filter(cemetery => cemetery.caskets.some(casket => casket.name.includes(casketSearch)));
//     }
...
//             {/* Add your local government options here */}
...
//             type="text"
//             className="border rounded-lg p-2 mb-2 md:mb-0"
//             placeholder="Search Casket"
//             value={casketSearch}
//             onChange={(e) => setCasketSearch(e.target.value)}
//           />
...
//               {state && !flowerSearch && !verseSearch && !casketSearch && (
//                 <>
//                   <p><FaEnvelope /> {cemetery.email}</p>
//                   <p><FaPhoneAlt /> {cemetery.phone}</p>
//                   <p><FaMapMarkerAlt /> {cemetery.address}</p>
...
//                   <p><strong>Price per Space:</strong> {cemetery.cemeterySpacePrice}</p>
//                   {cemetery._id && (
...
//               {/* Conditional Direction Button */}
//               {location && (
//                 <a href={`https://www.google.com/maps/search/?api=1&query=${location}`} target="_blank" rel="noopener noreferrer">
//                   <button className="bg-gray-600 text-white px-2 py-1 rounded-lg mt-2">
//                     Directions
//                   </button>
//                 </a>
//               )}
