    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            const response = await axios.post(
              `${import.meta.env.VITE_API_U}/register`,
              formData,
              {
      ...
      <div className="w-full max-w-xs mx-auto">
        ...
        <div className="bg-white shadow-md rounded px-8 pt-1 pb-10 mt-1">
          <h2 className="text-2xl font-semibold mb-6 text-center">
            Register as an Admin/ an undertaker
          </h2>
          ...
          <p className="mt-4 text-center text-gray-500 text-sm">
            ...
            <a href="/undertakerlogin" className="text-blue-500 font-semibold">Login</a>
          </p>
        </div>
      </div>
    </div>
...
export default SignupUndertaker
