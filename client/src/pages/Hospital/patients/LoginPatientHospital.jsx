    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      <div className="w-full max-w-xs mx-auto">
        ...
        <div className="bg-white shadow-md rounded px-8 pt-1 pb-10 mt-1">
          <h2 className="text-2xl font-semibold mb-6 text-center">Login as a patient of an hospital</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className="mt-4 text-center text-gray-500 text-sm">
              ...
              <a href="/pforgotpassword" className="text-blue-500 font-semibold">
              Forgot Password?{' '}
              </a>
            </p>
          </form>
...
export default LoginPatientHospital;
