...
const LoginNurseHospital = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/nursedashboardhospital');
    } catch (err) {
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
      <div className="w-full max-w-xs mx-auto">
        ...
        <div className="bg-white shadow-md rounded px-8 pt-1 pb-10 mt-1">
          <h2 className="text-2xl font-semibold mb-6 text-center">Login as a nurse</h2>
...
export default LoginNurseHospital;
