import Payment from "../../models/HRMS/HRMSPayment.js";
...
const  hrmspayment= express.Router()


hrmspayment.post("/paystack/pay", async (req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/hrmsverifypayment`
  ...
  hrmspayment.get("/paystack/verify", async (req, res) => {
  ...
  if (paymentData.status === "success") {
    ...
    res.json({ redirectUrl: `${process.env.CLIENT_URL}/hrmslogin` });
    } else {
