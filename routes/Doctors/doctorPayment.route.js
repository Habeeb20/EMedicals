import Payment from "../../models/Doctors/DoctorPayment.js";
import express from "express"
import axios from "axios"
import crypto from "crypto"

const doctorpaymentrouter = express.Router()

doctorpaymentrouter.post("/paystack/pay", async(req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/dverifypayment`
...
doctorpaymentrouter.get("/paystack/verify", async(req, res) => {
  ...
  try {
    ...
    if (paymentData.status === "success") {
      ...
      res.json({ redirectUrl: `${process.env.CLIENT_URL}/doctorlogin` });
      } else {
...
export default doctorpaymentrouter