import Payment from "../../models/Telemedicine/telePayment.schema.js"
import express from "express"
import axios from "axios"
import crypto from "crypto"


const telePaymentrouter = express.Router()

telePaymentrouter.post("/paystack/pay", async(req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/televerifypayment`
...
telePaymentrouter.get("/paystack/verify", async(req, res) => {
    ...
    try {
        ...
        if (paymentData.status === "success") {
          ...
          res.json({ redirectUrl: `${process.env.CLIENT_URL}/telelogin` });
          } else {
...
export default telePaymentrouter