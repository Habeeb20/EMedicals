import Payment from "../../models/hospitals/Payment.js";
...
const hospitalpayment = express.Router()


hospitalpayment.post("/paystack/pay", async (req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/hverifypayment`
  ...
  hospitalpayment.get("/paystack/verify", async (req, res) => {
  ...
  if (paymentData.status === "success") {
    ...
    res.json({ redirectUrl: `${process.env.CLIENT_URL}/loginhospitaladmin` });
    } else {
