import Payment from "../../models/mortuary/MortuaryPayment.js"
import express from "express"
import axios from "axios"
import crypto from "crypto"


const mortuaryPaymentrouter = express.Router()

mortuaryPaymentrouter.post("/paystack/pay", async(req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/mverifypayment`
...
mortuaryPaymentrouter.get("/paystack/verify", async(req, res) => {
    ...
    try {
        ...
        if (paymentData.status === "success") {
          ...
          res.json({ redirectUrl: `${process.env.CLIENT_URL}/mlogin` });
          } else {
...
export default mortuaryPaymentrouter