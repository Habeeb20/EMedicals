...
import Payment from "../../models/Lab/LabPayment.js"
import express from "express"
import axios from "axios"
import crypto from "crypto"

const labPaymentrouter = express.Router()


labPaymentrouter.post("/paystack/pay", async (req, res) => {
    ...
    const data = {
        ...
        amount: amount * 100, 
        reference,
     callback_url: `${process.env.CLIENT_URL}/lverifypayment`
  ...
  labPaymentrouter.get("/paystack/verify", async (req, res) => {
  ...
  if (paymentData.status === "success") {
    ...
    res.json({ redirectUrl: `${process.env.CLIENT_URL}/lablogin` });
    } else {
...
export default labPaymentrouter